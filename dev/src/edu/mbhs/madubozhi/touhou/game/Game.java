...
public class Game extends JFrame implements Runnable {
	...
	private boolean spellcardrush = false;
	...
	public static void main(String [] args){new Game(Mode.LUNATIC, 1, null).setVisible(true);}
	 ...
	 */
	public Game(Mode m, int stage, FullGame par){
		super(DEFAULT_TITLE);
		this.parent = par;
