	...
	public void step(HashArray<Texture, Bullet> bullets){
		...
		while (!finished && internaltimer >= nextCueTime){
			...
			case 4:
				...
				break;
			case 5:
				Boss e5 = new Boss(5, BulletShape.BUBBLE_SQUARE, "orange", 4000, 4000, null, true, false, true);
				...
				break;
			case 6:
				Boss e6 = new Boss(1, BulletShape.ORB_LARGE, "red", 4000, 5000, null, true, false, false);
				...
				break;
			case 7:
				Boss e7a = new Boss(5, BulletShape.BUBBLE_SQUARE, "red", 4000, 5000, null, true, false ,true);
				e7a.addPath(new LinearBulletPath(new Point2D.Float(fWidth/2, fHeight/3), new Point2D.Float(fWidth/2, fHeight/3)));
				EnemyBullet e7b = new EnemyBullet(10, BulletShape.FAMILIAR, "", 1000, 2500, true, false, true);
				e7b.addPath(new LinearBulletPath(new Point2D.Float(fWidth/2, fHeight/2), new Point2D.Float(fWidth/2, fHeight/2)));
				spellcard = 5;
				bullets.put(e7a.getSprite(), e7a);
				bullets.put(e7b.getSprite(), e7b);
				break;
			case 8:
				Boss e8 = new Boss(5, BulletShape.BUBBLE_SQUARE, "blue", 8000, 10000, null, true, false, true);
				...
				break;
			case 9:
				Boss e9 = new Boss(5, BulletShape.BUBBLE, "orange", 8000, 10000, null, true, false, false);
				...
				break;
			case 10:
				Boss e10a = new Boss(100, BulletShape.BUBBLE_SQUARE, "orange", 12000, 15000, null, true, false, true);
		...
		case 13:
			...
			if (internaltimer%(difficulty.getBulletNumber()/3)==0){
				...
				ArcBulletPattern arc = new ArcBulletPattern(
						...
						new Bullet(10, new Dimension(size, size), ImageHash.IMG.getTex("snowflake_teal"), new Dimension((int)(size*3), (int)(size*3)), true, true, true),
						new LinearBulletPath(new Point2D.Float((float)(Math.random()*FullGame.WIDTH), -size), new Point2D.Float((float)(Math.random()*FullGame.WIDTH), FullGame.HEIGHT+size)),
						false, false);
				for (Bullet b:arc.step()){
					bullets.put(b.getSprite(), b);
				}
