...
/**
 * Java swing extension that is used in displaying the game panel, which includes the GLCanvas for the game, and the
 * SocrePanel displaying game info
 * @author bowenzhi
 *
 */
public class GameWindow extends JFrame {
	...
	/**
	 * Sets up a GameWindow with the following initial conditions
	 * @param m Difficulty level
	 * @param stage Stage number
	 * @param par Parent window
	 * @param glc GLCapabilities required for the game to render
	 * @throws AWTException
	 */
	...
	/**
	 * Kills all threads associated with this GameWindow and its components, allowing for memory to be restored for use
	 * elsewhere once the game is over
	 */
