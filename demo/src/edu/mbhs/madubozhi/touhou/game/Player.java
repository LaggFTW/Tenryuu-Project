...
//			if (sfx) {new SoundEffect(2).playToStop();}
	...
	/**
	 * Applies effects of player abilities when defensive bombs are used
	 * @param input Keyboard input to use
	 * @param barrier Reference to a BarrierBullet, in the case that the player's defensive bomb utilizes it
	 */
	...
	/**
	 * Applies effects of player abilities when offensive bombs are used
	 * @param input Keyboard input to use
	 * @param launchedBulletsIn Reference for the game's master HashArray of bullets present in the game 
	 */
	...
	/**
	 * Called when the player dies. Starts invincibility and explosion timers
	 */
	public void death() {
	...
	/**
	 * Increments through all timers and flags present, and updates any flags necessary
	 */
	...
	/**
	 * @return A float from 0.0f to 1.0f representing how much time should flow the next frame (1.0f = full speed, 
	 * 0.0f = zero speed)
	 */
