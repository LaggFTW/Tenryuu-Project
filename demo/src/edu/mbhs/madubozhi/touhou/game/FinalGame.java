 ...
 * Processing is called once the game is started, which then runs through the progression of this game sequentially 
 * on a single thread (forks do occur for processing optimization). Processing occurs in the following order:
 * <ol>
...
public class FinalGame extends GLCanvas {
	...
	/**
	 * Instantiates this FinalGame class, with the following initial conditions
	 * @param m Difficulty level
	 * @param stage Stage number
	 * @param par Parent window
	 * @param glc GLCapabilities required to render using OpenGL
	 * @param bgm Whether background music is enabled/disabled
	 * @param sfx Whether sound effects are enabled/disabled
	 */
	...
	/**
	 * Sets up initial conditions required for the game, including the screen size; calls initGame.
	 */
	private void init(){
	...
	/**
	 * Sets up initial conditions specific to the game, this includes setting up the score, player, and other game
	 * flags.
	 */
	...
	/**
	 * Advances the level by one, beginning a new level.
	 */
	 ...
	 * (forks do occur for processing optimization). Processing occurs in the following order:
	 * <ol>
	 * <li>Checks for player deaths and bullet collisions, as well as on-screen pickup items
	 * <li>Steps through player movements and actions (ie. shooting bullets, activating bombs)
	 * <li>Steps through all bullets and pickup items on screen
	...
	/**
	 * Loops through the list of all bullets, including bullets and effects created by player special abilities,
	 * checks collisions and graze, handles incrementing of positions, and manages more complex pattern expansions.
	 */
	...
	/**
	 * Loops through the list of all player-launched bullets, including bullets and effects created by player special 
	 * abilities, and handles updating of positions, as well as removal.
	 */
	...
	/**
	 * Clears away only the bullets that are not destroyable enemies. Used during offensive bombs.
	 */
	...
	/**
	 * Handles communications between the engine and the level parser, advancing patterns and levels when necessary.
	 */
	...
	/**
	 * Renders the game panel, the player, and the bullets
	 * @param gl GL object necessary to carry out rendering
	 */
	...
	/**
	 * Renders the borders of the game panel
	 * @param gl GL object necessary to carry out rendering
	 */
	...
	/**
	 * Renders the background of the game panel
	 * @param gl GL object necessary to carry out rendering
	 */
	...
	/**
	 * Terminates all threads relating to this game, so that the game may be stopped
	 */
